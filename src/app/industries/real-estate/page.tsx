...
export default function RealEstatePage() {
  ...
  const tiers = [{'label': 'Boutique Brokerage', 'range': '$35K - $70K', 'timeline': '10-14 weeks'}, {'label': 'Regional Agency', 'range': '$70K - $150K', 'timeline': '14-20 weeks'}, {'label': 'National Franchise', 'range': '$150K - $350K+', 'timeline': '20-28 weeks'}, {'label': 'Enterprise Custom', 'range': '$350K+', 'timeline': 'Custom'}];
