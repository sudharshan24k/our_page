...
export default function HealthcarePage() {
  ...
  const tiers = [{'label': 'Private Practice', 'range': '$400 - $800', 'timeline': '10-14 weeks'}, {'label': 'Multi-Specialty Clinic', 'range': '$800 - $1,500', 'timeline': '14-20 weeks'}, {'label': 'Hospital Network', 'range': '$1,500 - $2,000', 'timeline': '20-30 weeks'}, {'label': 'Enterprise Health Custom', 'range': '$2,000+', 'timeline': 'Custom'}];
