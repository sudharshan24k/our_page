...
export const metadata: Metadata = {
  title: 'AI Automation Cost Guide | EduraTech',
  description: 'How much does AI automation cost? Discover the ROI and pricing models for automating your business workflows.',
};
        ...
        <Container className="relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-lg md:text-xl text-zinc-400 leading-relaxed font-light text-balance max-w-3xl mx-auto">
              How much does AI automation cost? Discover the ROI and pricing models for automating your business workflows.
            </p>
      ...
      <Section className="py-24 bg-[#050505]">
        <Container className="max-w-3xl">
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <p>
              When evaluating ai automation cost, it's crucial to look beyond the initial build price and consider the total cost of ownership, ROI, and the long-term value of the solution.
            </p>
